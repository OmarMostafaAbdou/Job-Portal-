            ...
            <div class="col rounded " id="fixed">
                <div class="settings tabshow">
                    ...
                    foreach ($result as $item) {
                        ...
                        echo "<img src='../images/$item[img]' class='tm-list-item-img' style='width: 35%; align-self: center;'>";
                        echo "<h2>الاسم</h2> ";
                        ...
                        echo "<button style='margin-bottom: 15px; margin-top: 0px; align-self: self-start;' class='btn stnBtn' onclick='back()'>الإعدادات</button>";
            ...
            <div class="col rounded ">
                ...
                <div class="post">
                    ...
                    <li class="nav-item dropdown mt-3">
                        ...
                        <ul class="dropdown-menu">
                            <select class="form-select form-select-sm " aria-label="form-select-sm example">
                                <option class="dropdown-item" value="1">نجارة</option>
                                <option class="dropdown-item" value="2">سباكة</option>
                                <option class="dropdown-item" value="3">أشغال يدوية</option>
                                <option class="dropdown-item" value="3">مطبخ</option>
                                <option class="dropdown-item" value="3">نقاشة</option>
                            </select>
                ...
                <div class="history">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col card mb-2">
                            <h5 class="card-header">سباكة</h5>
                            <div class="card-body">
                                <h5 class="card-title">152جم</h5>
                                <p class="card-text">سشتبلاتنلابغاشسرلبغعشسبرشع</p>
                                <button class="btn btnPost">تفاصيل</button>
                            </div>
                        </div>
                        <div class="col card mb-2">
                            <h5 class="card-header">سباكة</h5>
            ...
            <div class="col rounded " id="col" style="display:none;">
                ...
                <div class="rightbox">
                    ...
                    <div class="profile tabshow" id="show">
                        ...
                        <h2>الاسم بالكامل</h2>
                        <input type="text" class="input" placeholder="الاسم بالكامل" />
                        <h2>تاريخ الميلاد</h2>
                        <input type="text" class="input" placeholder="مثال:30/1/1997" />
                        <h2>النوع</h2>
                        <input type="text" class="input" placeholder="نوعك" />
                        <h2>البريد الإلكتروني</h2>
                        <input type="text" class="input" placeholder="ex:youremail@wow.com" />
                        <h2>كلمة السر</h2>
                        <input type="password" class="input" placeholder="كلمة السر" />
